...
export class GenerateContext {
    ...
    public constructor(public host: Host, public codeModel: TestCodeModel, public testConfig: TestConfig) {
        ...
        this.importManager.add(this.testConfig.getValue(Config.module, `github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/${this.packageName.substr(3)}/${this.packageName}`));
    }
}
